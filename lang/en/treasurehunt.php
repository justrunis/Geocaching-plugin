<?php
// This file is part of Geocaching for Moodle
//
...
/**
 * Strings for component 'geocaching', language 'en'
 *
...
For the activities of the game to be displayed in the list it must be enabled the completion activity in
Moodle\'s configuration, in the game and the activity itself.';
...
If disabled, players will be able to start play right away.';
$string['alwaysshowdescription'] = 'Always show description';
$string['alwaysshowdescription_help'] = 'If disabled, the geocaching Description above will only become visible to players
...
$string['attemptsdeleted'] = 'Geocaching attempts deleted';
$string['availability'] = 'Availability';
$string['back'] = 'Back';
$string['backtocourse'] = 'Back to the game';
...
create a new geocaching.';
$string['configmaximumgrade'] = 'The default grade that the geocaching grade is scaled to be out of.';
$string['confirm'] = 'Confirm';
$string['confirmdeletestage'] = 'The stage was successfully removed';
$string['continue'] = 'Continue';
$string['correctanswer'] = 'Correct answer.';
$string['cleartreasurehunt'] = 'Reset the geocaching';
...
$string['cutoffdate_help'] = 'If set, the geocaching will not accept attempts after this date without an extension.';
...
$string['editingtreasurehunt'] = 'Editing geocaching';
...
$string['editactivity_help'] = 'You can find a step-by-step tutorial about creating geocaching activities at <a href="http://juacas.github.io/moodle-mod_treasurehunt/create_activity.html"> this page.</a>';
...
$string['eventhuntsucceded'] = 'Geocaching successfully finished';
...
$string['exit'] = 'Back to start';
$string['backtoview'] = 'Back to view page';
...
$string['playerstyle_help'] = 'There are several styles of the game screen that organizers can choose';
...
<p>In order to use the GPS to locate this device during the Geocaching, the server must be accessed by secure HTTPS URLs.
...
$string['gradesdeleted'] = 'Geocaching grades deleted';
...
$string['groupmode'] = 'players play in groups';
$string['groupmode_help'] = 'If enabled players will be divided into groups based on the configuration of game groups.
...
$string['huntcompleted'] = 'You have already completed this geocaching';
...
$string['notreasurehunts'] = 'There is no geocaching in this game';
...
$string['playstagewithoutmoving_help'] = 'If this option is enabled, players can discover this stage without moving to any place.
...
$string['playstagewithqr_help'] = 'If this option has a value, players can discover this stage by scanning a QR code available at that location.';

$string['playwithoutmoving'] = 'Playing without moving';
$string['playwithoutmoving_help'] = 'If this option is enabled, players may play from their computers without moving to
...
$string['pluginadministration'] = 'geocaching administration';
$string['pluginname'] = 'Geocaching';
$string['qrreaded'] = 'QR code readed:';
$string['question'] = 'Question';
$string['remove'] = 'Delete';
$string['removealltreasurehuntattempts'] = 'Delete all geocachings attempts';
...
$string['road'] = 'Road 1';
$string['roadmap'] = 'Road';
$string['roadended'] = 'This road is complete. Congratulations! You have done the geocaching. You can check go back by pressing Back to start button at the bottom';
...
In case it is the last stage, must leave a feedback message indicating that the geocaching has ended.';
...
$string['treasurehunt'] = 'Geocaching';
$string['treasurehunt:addinstance'] = 'Add a new geocaching';
$string['treasurehunt:addroad'] = 'Add road';
$string['treasurehunt:addstage'] = 'Add stage';
$string['treasurehuntclosed'] = 'This geocaching closed {$a}';
$string['treasurehuntcloses'] = 'Geocaching closes';
$string['treasurehuntcloseson'] = 'This geocaching will close {$a}';
$string['treasurehunt:editroad'] = 'Edit road';
$string['treasurehunt:editstage'] = 'Edit stage';
$string['treasurehuntislocked'] = '{$a} is editing this geocaching right now. Try to edit it in a few minutes.';
$string['treasurehunt:managetreasure'] = 'Manage geocaching';
$string['treasurehunt:managetreasurehunt'] = 'Manage geocaching';
$string['treasurehuntname'] = 'Geocaching\'s name';
$string['treasurehuntnotavailable'] = 'The geocaching will be available {$a}';
$string['treasurehuntopens'] = 'Geocaching opens';
$string['treasurehuntopenedon'] = 'This geocaching opened {$a}';
$string['treasurehunt:play'] = 'Play';
$string['treasurehunt:view'] = 'View geocaching';
...
$string['warnqrscanner'] = '<table><tr><td> This Geocaching includes {$a} stages with QRCodes.
...
$string['warnqrscannersuccess'] = 'This Geocaching includes {$a} stages with QRCodes.
It seems that you have passed a QR test with this device.';
$string['warnqrscannererror'] = 'This Geocaching includes {$a} stages with QRCodes.
It seems that your device can not use the camera with this application. Please give permissions to access the camera.
If you can\'t manage to activate the camera this device may not be suitable to play the Geocaching.';
...
to locate the players during the Geocaching the server must be accessed by secure HTTPS URLs. In other case, only "Play without moving" mode
...
$string['addroad_tour'] = 'Add one or more roads to be followed by your players.';
$string['editend_tour'] = 'Enjoy making exciting games for your players!';
...
$string['playend_tour'] = '<span style="font-size: 1.5em; font-weight: bold">Enjoy your geocaching</span><br>with your mates!';
...
// Privacy strings.
$string['privacy:metadata_treasurehunt_track'] = 'The geocaching stores the sequence of locations followed by a user during the activity.';
$string['privacy:metadata_treasurehunt_track_userid'] = 'The ID of the user being tracked.';
$string['privacy:metadata_treasurehunt_track_treasurehuntid'] = 'The ID of the geocaching the user is playing in.';
...
$string['privacy:metadata_treasurehunt_attempts'] = 'The geocaching stores the type, time and location of the attempts, successes and failures of the users during the activity';
