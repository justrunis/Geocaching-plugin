...
define(['jquery', 'core/str'], function ($, str) {
    ...
    var dyndates = {
         ...
         * @param int|null curtime unix timestamp to compare to. If null current time.
         * @return string formatted interval
         */
        get_nice_date: async function (time, longdate = 200, mediumdate = 4, curtime = null) {
            var timestringkey;

            if (curtime === null) {
                curtime = Date.now() / 1000; // To seconds.
            }
            var dif = curtime - time;
            var now = new Date();
